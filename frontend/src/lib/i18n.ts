...
const en = {
  ...
  notifyHint: "We'll message you on Telegram the moment it's back",
  notifyNeedsTelegram: 'Open in Telegram to get notified',
  keys: 'Keys',
  left: 'left',
  only: 'only!',
...
const am: Dict = {
  ...
  notifyMe: 'አሳውቅኝ',
  notifyDone: 'ተመዝግበዋል!',
  notifyHint: 'ምርቱ ሲመለስ በቴሌግራም እናሳውቅዎታለን',
  notifyNeedsTelegram: 'ማሳወቂያ ለመቀበል በቴሌግራም ይክፈቱ',
  keys: 'ቁልፎች',
  left: 'ብቻ ቀርተዋል',
  only: 'ብቻ!',
